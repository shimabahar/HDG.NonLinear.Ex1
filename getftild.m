...
% Building matrix ftild_2
ftild_2 = zeros(n*ne, 1);
ftild_2 = (1/dt) * A * (U1-U);

% Building matrix ftild_3
ftild_3 = zeros(n*ne, 1);
ftild_3 = B' * U1;

% Building matrix ftild_4
...
for i = 1:ne
    ...
    for j = 1:1:n
        ...
        ftild_53(k+j,1) = (-6*abs(Landa1(i+1)) + tau0) * ...
                          (Landa1(i+1)*phi(j, i, b)) - ...
                          (Landa1(i)*phi(j, i, a)) * ...
                          (-6*abs(Landa1(i)) + tau0);
    end
...
for i = 1:ne
    ...
    for l = 1:n
        ftild_52(k+l,1) = (-6*abs(Landa1(i+1)) + tau0)*g2*phi(j, i, b) ...
                           - (-6*abs(Landa1(i)) + tau0)*g1*phi(j, i, a);
    end;
    k = k + n;
    z = z + n;
end;
